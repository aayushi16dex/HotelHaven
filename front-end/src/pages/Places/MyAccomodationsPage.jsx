        ...
        <div>
            ...
            <div className="mt-8 w-3/4 mx-auto">
                ...
                {places.length === 0 && (
                    <div>
                        <div className="text-center">
                            <h1 className="text-2xl mb-5">You have not added any hotels yet!</h1>
                            <h3 className="text-lg"> From cozy cottages to luxurious hotels to enchanted villa,</h3>
                            <h3 className="text-lg">add any accommodation you want.</h3>
                        </div>

                        <img className="mx-auto mt-3 h-32  rounded-full " src={`${apiUrl}/uploads/hotelImg.jpg`} alt="" />

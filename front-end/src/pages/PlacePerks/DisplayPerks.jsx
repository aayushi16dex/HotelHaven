export default function DisplayPerks({ perk }) {

    const perkClasses = ["flex gap-2 text-gray-600 border border-gray-300 font-semibold p-3 rounded-xl m-2"];
    return (
        <>
            {(perk === "wifi") && (
                <div className={perkClasses}>
